...
namespace Infrastructure.DataAccess
{
    public class CalculatorContext : DbContext
    {
        ...
        public void LoadDbInMemory()
        {
            ...
            {
                new Measure { Id = 1, Name = "Metres", Abbreviation = "m", Description = "Metres" },
                new Measure { Id = 2, Name = "Kilometres", Abbreviation = "km", Description = "Kilometres" },
                new Measure { Id = 3, Name = "Miles", Abbreviation = "mi", Description = "Miles" },
                new Measure { Id = 4, Name = "Feets", Abbreviation = "ft", Description = "Feets" }
            };
